...
\newenvironment{citecolor}
    {\footnotesize\begin{color}{slate}}
    {\end{color}}
...
% Table Highlighting --------------------------------
% Create top-left and bottom-right markers in tabular cells with a unique matching id and these commands will outline those cells
...
% make sure a note page is generated for every slide even if there are no notes
\makeatletter
